...
if __name__ == '__main__':
    predictor_path = 'model/predictor_mydata.dat'  #내 dat 파일 넣으면 시각화 결과 
    predictor = dlib.shape_predictor(predictor_path)  #

    f = open('image.txt', 'r')  #수정X
    lines = f.readlines()
    ...
    while i < len(lines):
        ...
        cv2.putText(image, 'mydata', (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 2)
        ...
        cv2.imwrite('output/{}/{}_mydata.jpg'.format(dir, name), image)
