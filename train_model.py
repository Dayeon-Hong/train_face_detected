...
# parts.
training_xml_path = 'mydata.xml' #내xml
#test_xml_path = 'IBUG.xml'
test_xml_path = 'HELENs.xml'#helenxml 다시 넣기 
#t1 = time.clock() #성능측정
t1 = time.process_time()
print('Training...')
dlib.train_shape_predictor(training_xml_path, 'model/predictor_mydata.dat', options) #train**가운데자리에, 빈파일 
...
print("\nAccuracy: {}".format(   #테스트 하는 부분 
    dlib.test_shape_predictor(test_xml_path, 'model/predictor_mydata.dat')))    #내 dat 파일 넣기 결과로 정확도만 나오는 
...
#predictor = dlib.shape_predictor("predictor_mydata.dat")
